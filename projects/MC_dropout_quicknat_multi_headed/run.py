...
from projects.MC_dropout_quicknat_multi_headed.evaluator import Evaluator
from projects.MC_dropout_quicknat_multi_headed.parts.quicknat import QuickNat
from projects.MC_dropout_quicknat_multi_headed.solver import Solver
...
class Executor(ExecutorInterface, Evaluator):
    ...
    def train(self, train_params, common_params, data_params, net_params, utils=None):
        ...
        solver = Solver(model=model,
                        ...
                        loss_func=additional_losses.KLDCEMultiHeadedCombinedLoss(net_params['gamma_value'],
