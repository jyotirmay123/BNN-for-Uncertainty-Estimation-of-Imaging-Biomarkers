...
from projects.probabilistic_quicknat.evaluator import Evaluator
from projects.probabilistic_quicknat.parts.pu_net import ProbabilisticUNet
from projects.probabilistic_quicknat.solver import Solver
...
class Executor(ExecutorInterface, Evaluator):
    ...
    def train(self, train_params, common_params, data_params, net_params, utils=None):
        ...
        if train_params['use_pre_trained']:
            ...
            model = ProbabilisticUNet(net_params)
